...
export const getAllFood = (_id) => async (dispatch) => {
  try {
    ...
    const foodData = await axios({
      method: "GET",
      url: `https://thetiffinwala.onrender.com/api/v1/food/provider/${_id}`,
    });
...
export const getFoodById = (_id) => async (dispatch) => {
  try {
    ...
    const food = await axios({
      method: "GET",
      url: ` https://thetiffinwala.onrender.com/api/v1/food/${_id}`,
    });
...
export const addFood = (data) => async (dispatch) => {
  try {
    ...
    const food = await axios({
      method: "POST",
      url: "https://thetiffinwala.onrender.com/api/v1/food",
      data,
    });
